...
//        long numOfCols = invoicesItemsTableModel.getColumnCount();
        ...
        for (int i = 0 ; i< (numOfRows);i++)
        {
            ...
            invoiceLineArrayList.add(new InvoiceLine(Integer.parseInt(arr[0]),arr[1], Double.parseDouble(arr[2]),Integer.parseInt(arr[3])));
    ...
    public void writeRows(ArrayList<InvoiceLine> readInvoiceLines) {
        ...
        for (int i = 0; i < readInvoiceLines.size(); i++) {
            ...
            double invoiceLineTotal = itemPrice*itemCount;
